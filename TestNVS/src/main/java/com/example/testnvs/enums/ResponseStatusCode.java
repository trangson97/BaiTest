package com.example.testnvs.enums;
...
public enum ResponseStatusCode {
    ...
    USERNAME_IS_EMPTY(550, "Username không được trống"),
    PASSWORD_IS_EMPTY(551, "Password không được trống"),
    NAME_IS_EMPTY(552, "Name không được trống")

    ;

//    SUCCESS(1002, "Thành công");
